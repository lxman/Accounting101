...
public static class RootGroups
{
    ...
    {
        IMongoCollection<RootGroup>? rootGroups = dataStore.GetCollection<RootGroup>(dbName, CollectionNames.RootGroups);
    ...
    {
        return await dataStore.GetCollection<RootGroup>(dbName, CollectionNames.RootGroups)
    ...
    {
        ReplaceOneResult result = await dataStore.GetCollection<RootGroup>(dbName, CollectionNames.RootGroups)
