...
/// <summary>
/// Boots the real composition-root host (engine + Receivables + Payables + Payroll + Cash + Reconciliation
/// — all modules) against a disposable EphemeralMongo, with each module's loopback ledger HttpClient
/// repointed at the in-memory test server (no real socket). This is the live multi-module composition
/// proof with the Reconciliation module included.
/// <para>
