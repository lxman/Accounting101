...
/// <summary>
/// A disposable EphemeralMongo instance wired up exactly as the host would wire the payables module:
/// a registered client + member + the "payables" module, and a real <see cref="ScopedDocumentStore"/>
/// bound to that identity with the payables manifest. Repository tests get a real document store to
/// exercise the actual policy/lifecycle behavior.
/// </summary>
public sealed class PayablesDocumentStoreFixture : IAsyncLifetime
{
