...
/// the credential. Those endpoints authorize <c>Approve</c>/<c>Reverse</c>/<c>Void</c> permissions,
/// not <c>Post</c>; the user carries those permissions today and the engine does not require a module
/// credential for them. Sending the credential anyway would be harmless but misleading — the module
