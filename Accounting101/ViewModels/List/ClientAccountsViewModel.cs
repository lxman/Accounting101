...
namespace Accounting101.ViewModels.List
{
    public class ClientAccountsViewModel : BaseViewModel
    {
        ...
        private void SetupDataGrid()
        {
            ...
            ((DataGrid)AccountsList).AutoGeneratedColumns += AlignColumns;
        }

        private static void AlignColumns(object? o, EventArgs e)
        {
            if (o is not DataGrid dataGrid)
            {
                return;
            }
            dataGrid.Columns[6].CellStyle = new Style(typeof(DataGridCell));
            dataGrid.Columns[6].CellStyle.Setters.Add(new Setter
            {
                Property = TextBlock.TextAlignmentProperty,
                Value = TextAlignment.Right
            });
            dataGrid.Columns[2].CellStyle = new Style(typeof(DataGridCell));
            dataGrid.Columns[2].CellStyle.Setters.Add(new Setter
            {
                Property = TextBlock.TextAlignmentProperty,
                Value = TextAlignment.Right
            });
