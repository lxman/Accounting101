...
/// engine authorize the post under the module path and stamp <c>ViaModule = "payroll"</c> on the
...
public sealed class HttpLedgerClient(
    ...
    [FromKeyedServices("payroll")] ModuleCredential credential) : ILedgerClient
{
