...
/// engine authorize the post under the module path and stamp <c>ViaModule = "inventory"</c> on the
...
public sealed class HttpLedgerClient(
    ...
    [FromKeyedServices("inventory")] ModuleCredential credential) : ILedgerClient
{
