...
/// identity with a .Reference("items") manifest. Store tests exercise the actual reference policy.</summary>
public sealed class ItemDocumentStoreFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        ModuleManifest manifest = new ModuleManifestBuilder().Reference("items").Build();
